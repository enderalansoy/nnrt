...
;     an additional (optional) parameter ':signed' which
;     can be set to be either 'true' or 'false', e.g.
;
;         (minimize <bv_term> :signed true)
;         (maximize <bv_term> :signed false)
;
...
;
(minimize x)
(minimize x :lower -100 :signed true)
